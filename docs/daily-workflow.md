...
**論点カード（`cards.points`）の位置に注意してください。** 令和の虎Secondは
画面下部に志願者の氏名・肩書きのテロップを出します。そこに論点カードを重ねると
相手のテロップを隠すことになります。帯は不透明なので文字が潰れることはありませんが、
**氏名が出ている間は避けて、詰めのやり取りに合わせて置いてください。**
